...
if (isset($_GET['delete_id'])) {
    ...
    $query = "DELETE FROM rent_items WHERE id = :id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_item'])) {
    ...
    $query = "UPDATE rent_items SET item_name = :item_name, category = :category, description = :description, price = :price, photo = :photo, qty = :qty WHERE id = :id";
    $stmt = $db->prepare($query);
    ...
    if ($stmt->execute()) {
        header('Location: rent_items.php'); // Redirect after update to refresh the page
...
<center><a href="add_rent_books.php" class="btn edit">Add Book</a></center>
&nbsp;&nbsp;
<center><a href="add_both.php" class="btn edit">Add Book for bot sell and rent</a></center>
<table>
<th colspan="7" class="text-center" id="title">rent_items</th>
        <tr>
            <th>ID</th>
            <th>Item Name</th>
            <th>Category</th>
        ...
        <?php foreach ($items as $item): ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="rent_items.php?delete_id=<?php echo $item['id']; ?>" onclick="return confirm('Are you sure you want to delete this item?')" class="btn delete">Delete</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
...
<div class="popup" id="edit-popup">
    <h3>Edit Item</h3>
    <form method="POST" action="rent_items.php">

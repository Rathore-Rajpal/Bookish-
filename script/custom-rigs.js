...
function display() {
   if (cabinet_selector.selectedIndex == 1) {
    document.getElementById('cabinet_image').src =
      'images/pc_cabinet/ant1.jpg';
  } else if (cabinet_selector.selectedIndex == 2) {
    document.getElementById('cabinet_image').src =
      'images/pc_cabinet/zebzium.jpg';
  } else if (cabinet_selector.selectedIndex == 3) {
    document.getElementById('cabinet_image').src =
      'images/pc_cabinet/artis.jpg';
  }else if (cabinet_selector.selectedIndex == 4) {
    document.getElementById('cabinet_image').src =
      'images/pc_cabinet/elite1000.jpg';
  }else if (cabinet_selector.selectedIndex == 5) {
    document.getElementById('cabinet_image').src =
      'images/pc_cabinet/zebatom.jpg';
  }else if (cabinet_selector.selectedIndex == 6) {
    document.getElementById('cabinet_image').src =
      'images/pc_cabinet/foxin.jpg';
  }else if (cabinet_selector.selectedIndex == 7) {
    document.getElementById('cabinet_image').src =
      'images/pc_cabinet/masterboxk501l.png';
  }else if (cabinet_selector.selectedIndex == 8) {
    document.getElementById('cabinet_image').src =
      'images/pc_cabinet/gamdias.jpg';
  }else if (cabinet_selector.selectedIndex == 9) {
    document.getElementById('cabinet_image').src =
      'images/pc_cabinet/h5flow.webp';
  }else if (cabinet_selector.selectedIndex == 10) {
    document.getElementById('cabinet_image').src =
      'images/pc_cabinet/deepcool.jpg';
  }
}

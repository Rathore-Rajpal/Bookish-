...
if (!empty($itemName) && !empty($category) && !empty($description) && !empty($price) && !empty($photoName) && !empty($quantity)) {
    $sql = "INSERT INTO rent_items (item_name, category, description, price, photo, qty) VALUES ('$itemName', '$category', '$description', '$price', '$photoName', '$quantity')";

    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="audio.php"><i class="fa-solid fa-headphones"></i>&nbsp;Audio Books</a></li>
            </ul>
        </nav>
    </header>

    <div class="container">
        <h1>Bookish..E-Books Collection</h1>
        <div class="search-container">
            <input type="text" placeholder="Search for e-books..." id="searchBar">
        ...
        <div class="book-gallery" id="bookGallery">
            ...
            // Fetch e-books from the 'ebooks' table
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<a href='" . $row['pdf_link'] . "' target='_blank'>";

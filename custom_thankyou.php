...
// Fetch the last order from the 'custom_orders' table
$sql = "SELECT * FROM `custom_orders` ORDER BY `srno` DESC LIMIT 1";
    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <h1>Bookish</h1>
                            ...
                            <td>
                                Order Date: <?php echo date("Y/m/d", strtotime($order['order_date'])); ?><br>
            ...
            <tr class="item">
                <td>
                    Book Name: <?php echo $order['book_name']; ?><br>
                    Author(s): <?php echo $order['authors']; ?><br>
            ...
            <tr class="total">
                <td></td>
                <td>Total: ₹<?php echo $order['total_amt']; ?></td>
            </tr>
        </table>

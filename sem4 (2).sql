...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 27, 2025 at 06:38 PM
...
(121, 'The Odyssey', 'New', 'hii', 300.00, '67a4b6c7581af_WhatsApp Image 2024-04-21 at 15.23.42_f980d279.jpg', '2025-02-06 13:19:10', 2);

-- --------------------------------------------------------

--
-- Table structure for table `buy_wishlist`
--

CREATE TABLE `buy_wishlist` (
  `srno` int(10) NOT NULL,
...
(33, 'yashzii', 'yashzii', '9175442260', 'asd', 'upi', 460, 'The Phonix and the Carpet', '1', 10);
...
(25, 'yashzii', 'Rajpal Singh', '9175442260', 'makrana rajasthan', 'debit_card', 28, 'Daddy-Long-Legs, The Phonix and the Carpet', '3, 2', '2024-10-16', '2024-10-21', 10),
(26, 'yashzii', 'Rajpal Singh', '9175442260', 'helllooooooo', 'debit_card', 13, 'Twilight Land', '3', '2024-10-19', '2024-10-22', 5),
(27, 'rajsaa', 'yuvraj singh', '9175442260', 'nandoloi', 'upi', 26, 'Through the looking glass', '3', '2024-10-27', '2024-10-30', 5);
...
(29, 'Daddy-Long-Legs', 'New', '&quot;Daddy-Long-Legs&quot; is a novel by Jean Webster, first published in 1912. The story follows Judy Abbott, an orphan who receives a scholarship to attend college from an anonymous benefactor whom she nicknames &quot;Daddy-Long-Legs&quot; due to his long legs that she glimpses as he leaves her orphanage. The novel is told through a series of charming and humorous letters from Judy to her mysterious sponsor. As she navigates her college life, friendships, and romantic interests, Judy&#039;s i', 300, '670a12b925ba7_book_1.jpeg', '2024-10-12 06:10:01', '7'),
(30, 'Twilight Land', 'New', '&quot;Twilight Land&quot; is a fantasy novel by Mabel H. McFarlane, published in 1916. The story follows a young girl named Maud who, feeling disconnected from the world around her, discovers a magical realm called Twilight Land. In this enchanting place, she encounters various whimsical characters and experiences adventures that challenge her understanding of reality and imagination.', 250, '670a13115d1b8_book_2.jpeg', '2024-10-12 06:11:29', '5'),
...
(80, 'Daddy-Long-Legs', 'New', 'gds', 121, '670cd947c2b95_WhatsApp Image 2024-04-21 at 15.24.29_69454f2e.jpg', '2024-10-14 08:42:00', '1'),
(81, 'The Odyssey', 'New', 'hii', 300, '67a4b6c7581af_WhatsApp Image 2024-04-21 at 15.23.42_f980d279.jpg', '2025-02-06 13:19:10', '2');
...
(23, 'raj@123', 'The Odyssey', 'New', 'hii', 300, 2, '67a4b6c7581af_WhatsApp Image 2024-04-21 at 15.23.42_f980d279.jpg', 'both', 'Rajpal Singh', '9175442260', 'Debit Card', 40, '2025-02-06 13:19:10');
...
(28, 'Amartya', 'Nair', 'amartya_nair', 'amartya@gmai.com', '$2y$10$QVjYz2zW3xsovcA/KZH.neEcDFCEEPo16xQbc8.Ybm6UVAfKdE4uW', '2025-04-01 06:09:07', 'profile_71022731.jpg');
...
--
-- Indexes for table `buy_wishlist`
--
ALTER TABLE `buy_wishlist`
  ADD PRIMARY KEY (`srno`);
...
--
-- AUTO_INCREMENT for table `buy_wishlist`
--
ALTER TABLE `buy_wishlist`
...
--
ALTER TABLE `orders`
  MODIFY `srno` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `sales`
  MODIFY `srno` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
